...
const HOST = "all-sport-live-stream.p.rapidapi.com";

const ALLOWED_PREFIXES = ["/api/v6/", "/api/v1/", "/api/v2/", "/api/all-streams"] as const;
...
export default async function handler(request: Request): Promise<Response> {
  ...
  const prefix = "/api/all-sport-live-stream";
