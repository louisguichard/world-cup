...
export const APP_COPY = {
  ...
  live: {
    ...
    bracketTreeNote:
      "Compact knockout tree below. Open the Bracket tab for the full pan/zoom split tree.",
    bracketFlowNote:
      "Swipe through knockout rounds below. Open the Bracket tab for the full tree or pan/zoom view.",
    ...
    scorers: {
      ...
      activeCareerKicker: "Active legends",
      activeCareerScorers: "Active legends · WC career",
      allTimeKicker: "All-time",
      allTimeTopScorers: "All-time top scorers",
      goalsThisTournament: "2026 goals",
      careerWcGoals: "World Cup career",
      through2022: "Through 2022",
      in2026: "In 2026",
      no2026Scorers: "No goals scored in 2026 yet.",
      noActiveLegends: "No active legends in the reference list yet.",
      seeAllScorers: "See all scorers",
    },
    groupStandings: {
  ...
  bracket: {
    ...
    flowLabel: "Flow",
    flowSubtitle: "Swipe left through rounds — R32 pairs feed into R16 and beyond.",
    flowSwipeHint: "Swipe sideways through knockout columns · pair groupings show who feeds the next round.",
    flowHalfLabel: "Bracket half",
    flowHalfLeft: "Left half",
    flowHalfRight: "Right half",
  ...
  goalScorer: {
    ...
    internationalGoals: "World Cup career",
