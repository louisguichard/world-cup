...
export type MatchDetailTab = "summary" | "watch" | "statistics" | "lineups" | "commentary" | "h2h" | "highlights";
...
export type MatchEventType = "goal" | "own_goal" | "yellow_card" | "red_card" | "yellow_red_card" | "substitution" | "var_review" | "goal_disallowed" | "penalty_missed" | "penalty_saved";
...
export declare const GROUP_STAGE_MATCH_COUNT = 72;
export declare const STORAGE_KEY = "world-cup-2026-score-overrides";
export declare const PICKS_KEY = "world-cup-2026-bracket-picks";
export declare const DATA_CACHE_KEY = "world-cup-2026-data-cache-v3";
export type SourceId = "wclive" | "espn" | "sportapi7" | "footapi7" | "zafronix" | "sofascore" | "freeapi" | "wc2026teams" | "static";
...
export type WeatherIconKind = "clear-day" | "clear-night" | "partly-cloudy-day" | "partly-cloudy-night" | "cloudy" | "rain" | "showers" | "thunderstorm" | "snow" | "fog" | "wind" | "unknown";
