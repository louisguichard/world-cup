 ...
 */
export type AuthorityLevel = "PRIMARY" | "BACKUP" | "COMPUTED" | "ANALYST_OVERRIDE";
export type EntityType = "team" | "player" | "match" | "competition" | "group" | "venue" | "city" | "country" | "weatherLocation" | "provider";
...
export type QualificationTier = "CHAMPION" | "RUNNER_UP" | "THIRD" | "ELIMINATED" | "QUALIFIED_TOP2" | "BEST_THIRD" | "UNKNOWN";
/** BC2 engine output — deterministic qualification state (not UI labels). */
export type QualificationEngineStatus = "qualified" | "at_risk" | "projected_out" | "eliminated" | "pending";
/** UI display tier — mapped from engine status via qualificationView only. */
export type QualificationDisplayTier = "qualified" | "alive" | "projected_out" | "eliminated";
export type QualificationEngineCertainty = "confirmed" | "projected_strong" | "projected_weak" | "projected";
...
export type QualificationCertainty = "CONFIRMED" | "LIKELY" | "POSSIBLE" | "UNCERTAIN";
